...
<%
	if (request.getAttribute("tcount") != null) {
		dto = (Dto) request.getAttribute("tcount");
		tcount = dto.getTcount();
...
<style type="text/css">
<%
if ((userid != null ) && (loginCheck == 1)) {%> #connect {
	display: table;
}
...
<body>
	<div id="mySidenav" class="sidenav">
		...
		<div class="ncolor">
			<a href="#">HOME</a> <a href="#">UALOAD</a> <a href="#">짤방</a> <a
				href="list.do">게시판</a> <a href="#">건의사항</a>
		</div>
	...
	<div id="main">
 	...
 	if (request.getAttribute("list") != null) {
		...
		<div id="write"
			style="position: fixed; top: 50px; left: 1330px; z-index: 1">
	...
	<div class="modal">
		...
		<table id="total_div" cellpadding="0" cellspacing="0" border="0" style="background-color: white;">
			...
			<tr>
				<td class="board_tb" id="board_content" colspan="2" width="400px" height="45%" style="text-align:left;vertical-align:top;font-size:10pt;overflow-y:scroll;word-break:break-all"><%=dto.getBcontent() %></td>
			</tr>
			<tr>
				<td class="board_tb" colspan="2" width="400px" height="45%" style="text-align:left;vertical-align:top;font-size:10pt;overflow-y:scroll;word-break:break-all">댓글 부분</td>
			</tr>
		...
		<div class="login">
			<table class="login_tb">
				<form action="login.do" name="login_form" method="post">
					...
					<tr>
						<td><input type="button" class="btnLogin"
							onclick="loginCheck()" value="로그인"></td>
					</tr>
					<tr>
		...
		<table align="center" class="join_tb">
			...
			<form action="join.do" name="join_form" method="post">
				...
				<tr>
					...
					<td><input type="text" name="userid" id="join_userid"
						maxlength="10" placeholder="아이디 입력(6~10자)" autofocus></td>
					<td><input type="button" id="btn_idCheck" value="중복확인">
				</tr>
				<tr>
					<td class="join_text">비밀번호</td>
					<td colspan="2"><input type="password" maxlength="10"
						name="userpw" placeholder="비밀번호 입력(6~10자)"></td>
				</tr>
				<tr>
					<td class="join_text">이름</td>
					<td colspan="2"><input type="text" maxlength="10"
						name="username" placeholder="이름 입력"></td>
				</tr>
				<tr>
					<td class="join_text">별명</td>
					<td><input type="text" name="usernickname" id="nickname"
						maxlength="10" placeholder="별명 입력"></td>
					<!-- ***** 변경하기0113 ***** -->
				...
				<!-- ***** 변경하기0113 ***** -->
				<tr>
					<td class="join_btn" colspan="4"><input type="reset"
						id="join_reset" value="다시 작성하기"></td>
				</tr>
				<tr>
					<td class="join_btn" colspan="4"><input type="button"
						id="join_btn" onclick="joinField()" value="가입하기"></td>
				</tr>
			</form>
		</table>
	</div>
	...
	<div class="informModify">
		<table align="center" class="join_tb">
			<!-- ***** 변경하기0113 ***** -->
			<form action="informModify.do?userid=<%=userid%>"
				name="informModify_form" method="post">
				<tr>
					<td class="join_title" colspan="5" align="center"><p>짤방연구소
							회원정보수정</p></td>
				...
				<tr>
					<td class="join_text">이름</td>
					<td colspan="2"><input type="text" maxlength="10"
						name="username" value="<%=username%>" readonly></td>
				</tr>
				<tr>
					<td class="join_text">별명</td>
					<td><input type="text" name="usernickname"
						id="modify_nickname" maxlength="10" value="<%=usernickname%>"></td>
					<!-- ***** 변경하기0113 ***** -->
					<td><input type="button" id="btn_modifyNicknameCheck"
						value="중복확인"></td>
				</tr>
				<tr>
					<td class="join_text">이메일</td>
					<!-- ***** 변경하기0113 ***** -->
					<td colspan="2"><input type="text" name="useremail" size="10"
						id="email" value="<%=email%>"> @ <select name="site">
							<option value="hanmail.net">hanmail.net
							<option value="hanmir.com">hanmir.com
							<option value="hotmail.com">hotmail.com
							<option value="nate.com">nate.com
				...
				<tr>
					<td class="join_btn" colspan="4"><input type="button"
						id="join_btn" onclick="informModify()" value="수정하기"></td>
				</tr>
			</form>
		</table>
	</div>
